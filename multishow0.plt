...
# OUTPUT
#==============================================================================
set output './plots/alternation_Female_Male.pdf'
set encoding utf8
#==============================================================================
# MULTIPLOT
#==============================================================================
set multiplot layout 1,1 rowsfirst downwards title 'Female/Male Alternation'
#==============================================================================
# SETUP COMMANDS
#==============================================================================
set xlabel '10-fold' enhanced textcolor '#404040'
set ylabel 'Average predicted wage' enhanced textcolor '#404040'
...
#==============================================================================
plot \
    'plot0.dat' index 0 using 0:($2):xtic(1) title 'Female' with linespoints linestyle 1 linewidth 2, \
    'plot0.dat' index 1 using 0:($2):xtic(1) title 'Female=>Male' with linespoints linestyle 2 linewidth 2
unset multiplot
